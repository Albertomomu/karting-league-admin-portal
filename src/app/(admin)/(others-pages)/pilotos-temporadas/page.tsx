...
export default function PilotosPage() {
  ...
  useEffect(() => {
    ...
    router.replace(`/pilotos-temporadas?${params.toString()}`);
            ...
            {paginated.map((entry) => (
              ...
              >
                ...
                <td className="p-3 flex gap-2">
                  <button
                    onClick={() => router.push(`/pilotos-temporadas/${entry.id}/editar`)}
